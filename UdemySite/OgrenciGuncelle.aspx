<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="OgrenciGuncelle.aspx.cs" Inherits="UdemySite.OgrenciGuncelle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <div class="form-group">
        ...
        <asp:TextBox ID="TxtOgrSoyad" runat="server" CssClass="form-control"></asp:TextBox>
         ...
         <br />
          <div>
        <asp:Label for="TxtOgrTelefon" runat="server">Öğrenci Telefon Numarası</asp:Label>
        ...
        <br />
           <div>
        <asp:Label for="TxtOgrFoto" runat="server">Fotoğraf</asp:Label>
