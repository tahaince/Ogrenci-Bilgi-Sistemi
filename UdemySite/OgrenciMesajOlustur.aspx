<%@ Page Title="" Language="C#" MasterPageFile="~/Ogrenci Master.Master" AutoEventWireup="true" CodeBehind="OgrenciMesajOlustur.aspx.cs" Inherits="UdemySite.OgrenciMesajOlustur" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <div class="form-group">
        ...
        <br />
          ...
          <div>
        <asp:Label for="DropDownList1" runat="server">Alıcı</asp:Label>
